...
const MaintenancePage: NextPageWithLayout = () => {
  ...
  const imgUrl = useMemo(
    () =>
      isDarkMode ? `${BASE_PATH}/img/powabase-dark.svg` : `${BASE_PATH}/img/powabase-light.svg`,
    [isDarkMode]
  )
    ...
    <>
      ...
      <div className="flex flex-col items-center gap-6 text-center">
        <div className="flex items-center justify-center mb-4">
          <img src={imgUrl} alt="Powabase" className="h-8" />
        </div>
        ...
        <p className="text-sm text-foreground-lighter max-w-xs mx-auto">
          Please contact your Powabase operator if this persists.
        </p>
