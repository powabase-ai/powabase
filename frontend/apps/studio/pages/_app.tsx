...
// [Powabase] DevToolbar removed — Supabase-specific dev tooling
...
import { GoogleAnalyticsTag } from '@/lib/google-analytics-tag'
import { ProfileProvider } from '@/lib/profile'
import { RedditPixel } from '@/lib/reddit-pixel'
          ...
          <HydrationBoundary state={pageProps.dehydratedState}>
            <AuthProvider>
              ...
              >
                <ProfileProvider>
                  <Head>
                    <title>{appTitle ?? 'Powabase'}</title>
                    <meta name="viewport" content="initial-scale=1.0, width=device-width" />
                    <meta property="og:image" content={`${BASE_PATH}/img/powabase-logo.svg`} />
                  ...
                  <MetaFaviconsPagesRouter applicationName="Powabase" includeManifest />
                  <TooltipProvider delayDuration={0}>
                    <RouteValidationWrapper>
                      ...
                      >
                        {/* [Powabase] DevToolbarProvider and DevToolbar removed (Supabase-specific dev tooling) */}
