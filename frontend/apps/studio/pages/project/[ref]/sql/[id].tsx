...
const SqlEditor: NextPageWithLayout = () => {
  ...
  useEffect(() => {
    if (ref && data && project) {
      // Skip project_id check — our content API stub doesn't return project_id,
      // which would cause a redirect loop (blink between tabs).
      // On Supabase platform this prevents cross-project snippet access.
