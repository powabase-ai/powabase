...
import { PageType, useRegisterCommands, useRegisterPage } from 'ui-patterns/CommandMenu'
...
export function useCreateCommands(options?: CommandOptions) {
  ...
  const sections = useMemo(
    ...
    [databaseCommands, authCommands, storageCommands, integrationsCommands, observabilityCommands]
  )
