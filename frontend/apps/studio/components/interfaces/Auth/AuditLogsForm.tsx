              ...
              <CardContent>
                ...
                {isDisabling && (
                  <Admonition
                    ...
                    description={
                      <p>
                        Future audit logs will only appear in the project’s auth logs. You are
                        responsible for backing up, copying, or migrating existing data
                        from the{' '}
