...
import { InfoIcon, RefreshCw, Trash, Users, WandSparklesIcon, X } from 'lucide-react'
      ...
      >
        <ul className="text-sm list-disc pl-4 my-3 flex flex-col gap-2">
          ...
          <li className="marker:text-foreground-light">
            ...
            improvements will only take effect once complete. If you encounter any issues, please
            contact Powabase support for assistance.
          </li>
        </ul>
      </ConfirmationModal>
