...
export const CreateCronJobSheet = ({ open, selectedCronJob, onClose }: CreateCronJobSheetProps) => {
  ...
  const [cronType, endpoint, method, httpHeaders, httpBody, timeoutMs, schema, functionName] =
    useWatch({
                            ...
                            >
                              {CRONJOB_DEFINITIONS.map((definition) => (
                                <RadioGroupStackedItem
                                  ...
                                  disabled={
                                    !pgNetExtensionInstalled && definition.value === 'http_request'
                                  }
                                  label=""
                                  showIndicator={false}
                                >
                      ...
                      <Admonition
                        ...
                        description={
                          <div className="flex flex-col gap-y-2">
                            <span>
                              This will allow you to send HTTP requests within your cron jobs
                            </span>
                            <ButtonTooltip
                              type="default"
                              className="w-min"
