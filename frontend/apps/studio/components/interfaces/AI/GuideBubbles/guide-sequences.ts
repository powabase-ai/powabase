...
export interface GuideStep {
  ...
  /** The step's instruction is "click this control": clicking the highlighted
   *  anchor advances the walkthrough as if Next was pressed — doing the thing
   *  IS the Next. Leave unset for informational steps and type-here steps
   *  (e.g. tables.name, the extensions search box), where a click on the
   *  anchor doesn't mean the user finished the instruction. */
...
export const GUIDE_SEQUENCES: Record<string, GuideSequence> = {
  connect: {
    ...
    steps: [
      { anchor: A.connect.button, advanceOnAnchorClick: true, title: 'Connect', placement: 'bottom', docsUrl: `${DOCS}/guides/auth-connection`,
  ...
  'create-table': {
    ...
    steps: [
      { anchor: A.tables.newTableButton, advanceOnAnchorClick: true, title: 'New table', placement: 'right', route: '/project/[ref]/editor', docsUrl: OVERVIEW,
      ...
      { anchor: A.tables.addColumn, advanceOnAnchorClick: true, title: 'Add columns', placement: 'top', waitForUserAction: true,
        body: 'Each column has a name and a type (text, int8, timestamptz, uuid, jsonb…). Click Add column for each field you need.' },
      { anchor: A.tables.rls, advanceOnAnchorClick: true, title: 'Row Level Security', placement: 'top', waitForUserAction: true,
  ...
  'add-sources': {
    ...
    steps: [
      { anchor: A.sources.newButton, advanceOnAnchorClick: true, title: 'Add a source', placement: 'bottom', route: '/project/[ref]/sources', docsUrl: OVERVIEW,
  ...
  'create-knowledge-base': {
    ...
    steps: [
      { anchor: A.knowledgeBases.createButton, advanceOnAnchorClick: true, title: 'Create a knowledge base', placement: 'bottom', route: '/project/[ref]/knowledge-bases', docsUrl: OVERVIEW,
        body: 'A knowledge base is a searchable index over your sources that powers retrieval (RAG). Click Create to make one.' },
      { anchor: A.knowledgeBases.indexingStrategy, advanceOnAnchorClick: true, title: 'Pick a strategy', placement: 'bottom', waitForUserAction: true,
      ...
      { anchor: A.knowledgeBases.detailAddSources, advanceOnAnchorClick: true, title: 'Add sources & index', placement: 'bottom', waitForUserAction: true,
  ...
  'create-agent': {
    ...
    steps: [
      { anchor: A.agents.createButton, advanceOnAnchorClick: true, title: 'Create an agent', placement: 'bottom', route: '/project/[ref]/agents', docsUrl: OVERVIEW,
        body: 'An agent is an AI worker with a model, a system prompt, tools, and knowledge. Click Create to make one.' },
      { anchor: A.agents.tabKnowledgeBases, advanceOnAnchorClick: true, title: 'Attach knowledge', placement: 'bottom', waitForUserAction: true,
  ...
  'create-orchestration': {
    ...
    steps: [
      { anchor: A.orchestrations.createButton, advanceOnAnchorClick: true, title: 'Create orchestration', placement: 'bottom', route: '/project/[ref]/orchestrations', docsUrl: OVERVIEW,
  ...
  'create-workflow': {
    ...
    steps: [
      { anchor: A.workflows.createButton, advanceOnAnchorClick: true, title: 'Create workflow', placement: 'bottom', route: '/project/[ref]/workflows', docsUrl: OVERVIEW,
  ...
  'sql-query': {
    ...
    steps: [
      { anchor: A.sql.newQuery, advanceOnAnchorClick: true, title: 'New query', placement: 'bottom', route: '/project/[ref]/sql', docsUrl: OVERVIEW,
        body: 'The SQL Editor runs Postgres against your project. Click New query to open a blank editor.' },
      { anchor: A.sql.run, advanceOnAnchorClick: true, title: 'Run it', placement: 'bottom', waitForUserAction: true,
  ...
  'create-storage-bucket': {
    ...
    steps: [
      { anchor: A.storage.newBucket, advanceOnAnchorClick: true, title: 'New bucket', placement: 'bottom', route: '/project/[ref]/storage/files', docsUrl: OVERVIEW,
        body: 'Storage holds files (images, docs, media). Click New bucket to create a container — public or private.' },
      { anchor: A.storage.upload, advanceOnAnchorClick: true, title: 'Upload files', placement: 'bottom', waitForUserAction: true,
  ...
  'add-user': {
    ...
    steps: [
      { anchor: A.auth.addUser, advanceOnAnchorClick: true, title: 'Add user', placement: 'bottom', route: '/project/[ref]/auth/users', docsUrl: OVERVIEW,
  ...
  'create-rls-policy': {
    ...
    steps: [
      { anchor: A.auth.newPolicy, advanceOnAnchorClick: true, title: 'Create policy', placement: 'bottom', route: '/project/[ref]/auth/policies', docsUrl: OVERVIEW,
  ...
  'database-functions': {
    ...
    steps: [
      { anchor: A.database.newFunction, advanceOnAnchorClick: true, title: 'New function', placement: 'bottom', route: '/project/[ref]/database/functions', docsUrl: OVERVIEW,
  ...
  'database-triggers': {
    ...
    steps: [
      { anchor: A.database.newTrigger, advanceOnAnchorClick: true, title: 'New trigger', placement: 'bottom', route: '/project/[ref]/database/triggers', docsUrl: OVERVIEW,
  ...
  'database-indexes': {
    ...
    steps: [
      { anchor: A.database.createIndex, advanceOnAnchorClick: true, title: 'Create index', placement: 'bottom', route: '/project/[ref]/database/indexes', docsUrl: OVERVIEW,
  ...
  'database-roles': {
    ...
    steps: [
      { anchor: A.database.addRole, advanceOnAnchorClick: true, title: 'Add role', placement: 'bottom', route: '/project/[ref]/database/roles', docsUrl: OVERVIEW,
  ...
  'auth-providers': {
    ...
    steps: [
      { anchor: A.auth.providers, advanceOnAnchorClick: true, title: 'Sign-in providers', placement: 'bottom', route: '/project/[ref]/auth/providers', docsUrl: OVERVIEW,
  ...
  'realtime-inspector': {
    ...
    steps: [
      { anchor: A.realtime.inspector, advanceOnAnchorClick: true, title: 'Start listening', placement: 'bottom', route: '/project/[ref]/realtime/inspector', docsUrl: OVERVIEW,
  ...
  'llm-provider-keys': {
    ...
    steps: [
      { anchor: A.settings.llmKeys, advanceOnAnchorClick: true, title: 'Add Key', placement: 'bottom', route: '/project/[ref]/settings/llm-keys', docsUrl: OVERVIEW,
  ...
  'manage-compute': {
    ...
    steps: [
      ...
      { anchor: A.compute.resize, advanceOnAnchorClick: true, title: 'Resize', placement: 'top', waitForUserAction: true,
