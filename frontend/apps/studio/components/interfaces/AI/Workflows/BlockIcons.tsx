// Font Awesome Free 7.2.0 solid-style icons inlined as React components.
// License: CC BY 4.0 (Icons). See https://fontawesome.com/license/free
//
// Filled glyphs are used for the workflow palette/node where thin-line lucide
// icons dissolve against tinted color tiles in the dark theme. Each component
// mirrors the lucide-react prop shape so it slots into the existing iconMap.

interface IconProps {
  className?: string;
  // Accepted for interface compatibility with lucide-react components;
  // filled glyphs have no strokes so the value is ignored.
  strokeWidth?: number;
}
...
export function CodeBranchIcon({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 448 512"
