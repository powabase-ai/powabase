...
export const gotrueClient = new AuthClient({
  ...
  // Disable auto-refresh on server — prevents "storage.getItem is not a function" crashes
  autoRefreshToken: !isServer,
  persistSession: !isServer,
  debug: debug ? (persistedDebug ? logIndexedDB : true) : false,
  lock: navigatorLockEnabled ? debuggableNavigatorLock : undefined,
  // Platform GoTrue behind Kong requires apikey header for authentication
