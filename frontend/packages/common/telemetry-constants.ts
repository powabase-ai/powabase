...
/**
 * User clicked the in-app API Docs button in the table editor toolbar,
 * opening docs.powabase.ai in a new tab. The sidebar API Docs entry is a
 * plain external link and does not currently emit this event.
 *
 * @group Events
 * @source studio
 * @page Table editor
...
export interface ApiDocsOpenedEvent {
  ...
  properties: {
    /**
     * Source of the click. Currently only `table_editor` is emitted.
     */
    source: string
  }
  groups: Partial<TelemetryGroups>
